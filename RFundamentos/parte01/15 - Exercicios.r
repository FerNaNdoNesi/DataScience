...
# Exercicio 8 - Usando s funÃ§Ã£o subset, crie um novo dataframe com o conjunto de dados do dataframe iris em que Sepal.Length > 7
...
# Exercicio 9 - Crie um dataframe que seja cÃ³pia do dataframe iris e usando a funÃ§Ã£o slice(), divida o dataframe em um subset de 15 linhas
