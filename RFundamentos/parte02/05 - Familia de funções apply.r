...
# Se voce estiver trabalhando com os objetos:

# list, numeric, character (list/vecor) => sapply ou lapply
# matrix, data.frame (agregaÃ§Ã£o por coluna) => by / tapply
# OperaÃ§Ãµes por linha ou operaÃ§Ãµes especÃ­ficas => apply
...
# Aplicando funÃ§Ãµes com sapply
sapply(lista1, mean)
