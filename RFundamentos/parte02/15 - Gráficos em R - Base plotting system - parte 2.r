...
# pch - sÃ­mbolo no plot
# xlab - label do eixo x
# ylab - label do eixo y
# las - como os labels dos eixos sÃ£o orientados
# bg - background color
# mfrow - nÃºmero de plots por linha
# mfcool - nÃºmero de plots por coluna
...
# title() - adiciona tÃ­tulo ao grafico
...
plot(iris$Sepal.Length, iris$Petal.Length,
     col = iris$Species,
     main = "GrÃ¡fico gerado a partir do Iris")
...
plot(1:6, las = 3, xlab = "lty 1:6", ylab = "", main = "Mais opÃ§Ãµes ao plot")
