...
# e agrupa as estatÃ­sticas por niveis. Agora, se fizermos sumarizacao de estatÃ­sticas, eh possivel visualizar
...
# Plot
# Agora se fizermos um plot, temos um boxplot para estas variÃ¡veis categoricas
