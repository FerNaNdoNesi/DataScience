...
# Armazenados como nÃºmero de dias desde 1 de Janeiro de 1970

# Time - representado por POSIXct
# Armazenados como nÃºmero de segundos desde 1 de Janeiro de 1970

# Formatando Datas
# %d: dia do mes em 2 dÃ­gitos (13)
# %m: mÃªs em 2 digitos (01)
# %y: ano em 2 digitos (82)
# %Y: ano em 4 dÃ­gitos (1982)
# %A: dia da semana (Friday)
# %a: dia da semana abreviado (Fri)
# %B: mÃªs (July)
# %b: mÃªs abreviado (Jul)
