...
# do.call()
# Executa uma fun̤̣o em um objeto
# *** ATENCAO ***
# As funcoes da familia apply aplicam uma funcao a cada elemento de um objeto (substitui um loop)
# A fun̤̣o do.call aplica uma fun̤̣o ao objeto inteiro e ṇo a cada elemento individualmente
?do.call
...
# O resultado da fun̤̣o lapply() pode ser obtido de outras formas
# Pacote plyr
