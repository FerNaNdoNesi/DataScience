...
any(is.na(arq_coop_credit_data)) # se existir valores nulos é necessário trata-los
any(is.na(arq_coop_credit_data$Renda))
any(is.na(arq_coop_credit_data$NumDep))

summary(arq_coop_credit_data$NumDep) #média 0
arq_coop_credit_data$NumDep[is.na(arq_coop_credit_data$NumDep)] <- 0 

summary(arq_coop_credit_data$Renda) #média: 5400
arq_coop_credit_data$Renda[is.na(arq_coop_credit_data$Renda)] <- 5400
...
#INICIO
arq_coop_credit_data$Idade <- as.double(arq_coop_credit_data$Idade)
arq_coop_credit_data$ParcMin <- as.double(arq_coop_credit_data$ParcMin)
arq_coop_credit_data$EmpAtiv <- as.double(arq_coop_credit_data$EmpAtiv)
arq_coop_credit_data$ParcMax <- as.double(arq_coop_credit_data$ParcMax)
arq_coop_credit_data$Invest <- as.double(arq_coop_credit_data$Invest)
